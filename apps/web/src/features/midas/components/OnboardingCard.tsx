...
const STEPS = [
  { num: 1, title: 'Add a wallet', description: 'Create a bank account, cash wallet, or credit card.' },
  { num: 2, title: 'Add categories', description: 'Create income sources (e.g. Salary) and expense categories (e.g. Groceries).' },
  { num: 3, title: 'Record a transaction', description: 'Log your first income or expense to see your dashboard come alive.' },
];
